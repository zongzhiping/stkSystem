...
<head>
	...
	<script type="text/javascript">
		function selectId(obj){
			var data = document.getElementsByName("deptId")[0].value ;
			alert(data) ;
		}
...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
	<li id="query"><a href="#" onclick="formSubmit('query','_self');this.blur();">查看</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr>
		<td>查看条件</td>
		<td>部门编号:
			<select name="deptId" style="width:120px" onchange="selectId(this)">
				<option>---请选择---</option>
				<c:forEach items="${deptList }" var="d">
