                        ...
                        <TD>
                            <TABLE id=grid
                                ...
                                <TR
                                    ...
                                    <TD align="center"><%=i + 1 %>.<%=tm.getTitle() %>
                                    </TD>
                        ...
                        <TD>
                            <TABLE id=grid
                                ...
                                <TR
                                        style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                                    <TD align="center">
                                        <textarea rows="1" cols="100" id="bc<%=id %>" name="bc<%=id %>"></textarea>
                                        <input type="hidden" id="id" name="id" value="<%=id%>">
                                    </TD>
                                </TR>
                                <%} %>
