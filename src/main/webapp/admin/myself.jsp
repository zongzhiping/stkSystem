...
action="<%=path %>/myselfmodify.action"
 method="post">
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff>
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>当前位置：管理首页 &gt; 我的资料&gt; 资料修改</TD></TR>
        <TR>
      ...
      align=center border=0>
          ...
          <TD>
            ...
            cellSpacing=1 cellPadding=2 rules=all border=0>
              ...
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                ...
                <TD><input type="text" id="password" name="password" value="<%=bean.getPassword() %>"/></TD>
                </TR>
                 <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <TD align="center">身份证</TD>
                <TD><input type="text" id="cardno" name="cardno" value="<%=bean.getCardno() %>"/></TD>
                </TR>
                 <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <TD align="center">姓名</TD>
                <TD><input type="text" id=realName name="realName" value="<%=bean.getRealName() %>"/></TD>
                </TR>
                 <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
        ...
        <TR >
          <TD align=right height=25>
           <INPUT class=button id=button1  value="确定" type="button" name=button1 onclick="add()" > 
             </TD></TR>
       </TBODY></TABLE></TD>
