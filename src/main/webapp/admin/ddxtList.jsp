    ...
    <SCRIPT type=text/javascript>
        ...
        function changePageA(obj) {
            with (document.getElementById("form1")) {
                method = "post";
                action = "<%=path%>/ddxtList.action?index=" + obj+"&subjectInfo=${subjectInfo}";
                submit();
            }
        }
        ...
        function changePage(obj) {
            ...
            with (document.getElementById("form1")) {
                method = "post";
                action = "<%=path%>/ddxtList.action?index=" + obj.value+"&subjectInfo=${subjectInfo}";
                submit();
            }
        }
        ...
        function modify() {
            ...
            if (count == 1) {
                with (document.getElementById("form1")) {
                    method = "post";
                    action = "<%=path %>/ddxtMb.action?id=" + j+"&subjectInfo=${subjectInfo}";
                    submit();
                }
            }
        }
        ...
        function deletes() {
            ...
            if (window.confirm("确认删除吗？")) {
                with (document.getElementById("form1")) {
                    method = "post";
                    action = "<%=path %>/ddxtDel.action?idList=" + arrayObj;
                    submit();
                }
            }
        }
        ...
        <TR>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
                    <TR>
                        <TD class=manageHead>当前位置：管理首页 &gt; 题库 &gt; 多选题管理</TD>
                    </TR>
                    <TR>
                        <TD height=2></TD>
                    </TR>
