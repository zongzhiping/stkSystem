...
action="<%=path %>/ddxtAdd.action?subjectInfo=${subjectInfo}"
method=post>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff>
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>当前位置：管理首页 &gt; 题库 &gt; 多选题添加</TD></TR>
        <TR>
          ...
          <TD>
            ...
            <TR 
              ...
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                ...
                <TD>
                 <input  type="checkbox"  name="da" value="A" />A
                <input  type="checkbox"  name="da" value="B" />B
                <input  type="checkbox"  name="da" value="C" />C
                <input  type="checkbox"  name="da" value="D" />D
                </TD>
                </TR>
